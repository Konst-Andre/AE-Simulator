...
Заміряно інструментом (`md5sum`) у сесії S80 · 19.09.2026; рядки S82 — 22.09.2026; S83 — 22.09.2026; S84 — 23.09.2026; S87 — 24.09.2026; S85 — 23.09.2026
...
|---|---|---|---|---|
| `summary/AE_Simulator_CHERGA.md` | `ecd4c911` | 8 КБ | у черзі є хоч один непройдений щабель | — |
| `summary/AE_Simulator_session_summary_S87_D2_TYSHA.md` | `277187ca` | 13 КБ | наступне самері не стало живим | — |
...
| `stand/a2/s86_olya_walk_v6_root.py` | `4ff2c8e7` | 26 КБ | детектор D2 на корені `?a2v2` (v5 + заглушка api.github.com, S86); з кроку 5.3: 60 ✓ · 6 ✗ заявлені (24–29 → крок 6) | D2 кроки 5б–7 |
| `stand/a2/s87_pub_stub_v4.py` | `193d9642` | 19 КБ | детектор D2 крок 5 + 5в: публікація кнопкою на заглушках зі станом (1–22), редактор читає main (20а–20в), тиха звірка на вході (23а–23г, HOLD-затримка); X109 33 ✓ | щабель 2 · D2 |
...
| `d2s5_2_apply_v1.py` (D2 крок 5.2) | `archive/apply/` | запечено в X106; вхід — X105 `e9aae4d6` з git |
| `d2s5_3_apply_v1.py` (D2 крок 5.3 · Р1 знято) | `archive/apply/` | запечено в X107; вхід — X106 `4254b656` з git |
...
| `s86_pub_stub_v2.py` · `s87_pub_stub_v3.py` | `archive/stand/` | поглинуті (S87): v2 → v3 (+23а–23г) → v4 (+20а–20в) |
