...
| `stand/a2/s86_sync_strip_v1.py` | `a9e8c25e` | 5 КБ | детектор D2 крок 5.2 — смуга запису `#m-sync` і поле коду (HTML/CSS) на 1920·1536·1280·760; X106: 29 ✓ · 0 ✗, X105 — вихід 2 | крок 5.3 поглине |
