#!/usr/bin/env python3
"""d1_a2v2_mock_build_v4_5.py · AE-Simulator · S83 · D1 v4.5 (В-118…В-126) — мокап A2 v2 на реальних даних (усі 43 сценарії повні)
живе доки: A2 v2 не портовано в продукт ходом D2 (після — в архів)
Вхід: корінь репо AE (data/scenarios.json, data/catalog.json, config.json, prompts/characters.md) і шаблон mock_a2v2_tpl_v4_5.html поруч.
Б4 (S77): список характерів — з носія prompts/characters.md (записи «## назва», порядок носія), не зі сценаріїв.
Запуск: python3 d1_a2v2_mock_build_v4_5.py <AE> <вихід.html>
...
tpl = (pathlib.Path(__file__).parent / 'mock_a2v2_tpl_v4_5.html').read_text(encoding='utf-8')
