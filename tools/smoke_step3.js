...
if(inj) W = W.replace(/judge: 3000 \}/g, "judge: 1200 }");
...
A(rungs.every(r => r.jt >= 3000),
  `стеля судді на всіх сходинках >= 3000 (виміряно: 1100 згоріло, 1978 вклалось упритул)`);
A(/const mine\s+= rotated\.filter/.test(W) && /ordered = mine\.concat\(foreign\)/.test(W),
  'чужий стартовий щабель відсунутий у кінець запасу — падіння не зливає відра');
