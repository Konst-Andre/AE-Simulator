#!/usr/bin/env python3
"""x99_composer_island_apply_v2.py · AE-Simulator · S82 · щабель 3 · крок 1–2 досьє композера
...
v2 (S82, планшет оператора): В-136 неактивна кнопка без тіні · В-137 нижній відступ розмови 64px —
  сяйво Аврори заміряно headless 1280: Δ12 на 40px, Δ6 на ~60px, чисто на 77px над композером.
