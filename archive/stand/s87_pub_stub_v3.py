# s87_pub_stub_v3.py · детектор D2 крок 5 + 5в «тиша для Олі» — публікація з острова КНОПКОЮ, на заглушках (корінь під ?a2v2)
...
# Запуск: python3 s87_pub_stub_v3.py <корінь AE з білдом index.html>
