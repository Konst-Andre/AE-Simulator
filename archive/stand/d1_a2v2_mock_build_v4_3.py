...
Вхід: корінь репо AE (data/scenarios.json, data/catalog.json, config.json, prompts/characters.md) і шаблон mock_a2v2_tpl_v4_3.html поруч.
...
tpl = (pathlib.Path(__file__).parent / 'mock_a2v2_tpl_v4_3.html').read_text(encoding='utf-8')
